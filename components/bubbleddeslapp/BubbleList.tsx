...
export interface BubbleListDESLAPPRef {
...
export interface BubbleListDESLAPPProps extends React.HTMLAttributes<HTMLDivElement> {
  prefixCls?: string;
...
const BubbleListDESLAPP: React.ForwardRefRenderFunction<
  BubbleListDESLAPPRef,
  BubbleListDESLAPPProps
> = (props, ref) => {
  const {
...
const ForwardBubbleList = React.forwardRef(BubbleListDESLAPP);
